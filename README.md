...
I'm a Software Engineer and Content Creator who currently works as a Frontend Developer at [InfoStrategy Technology](https://https://istrategytech.com/). I'm passionate about sharing knowledge, documentation, web engineering and others. I create technical content (on my [Blog](https://hashnode.com/@Ademary), build useful [open-source projects](https://github.com/Kaempy), speak at some meetups/conferences, build technical communities...
